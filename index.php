  ...
  <div class="container">
    ...
    <a href="#intro" class="btn btn-default smoothScroll">GET STARTED</a>
      <!-- <div class="col-md-12 col-sm-12">
        <h1 class="wow bounceInDown rotate">Apex</h1>
...
<div class="navbar navbar-default navbar-static-top" role="navigation">
  <div class="container">
    <div class="navbar-header">
      ...
      <a href="index.html" class="navbar-brand">Apex</a></div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 col-sm-4 title">
        <h2>Service</h2>
        <hr>
        <p>We provide Interior Decoration,2D/3D animation,Design,Renovation and etc.</p>
      </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 col-sm-4 col-xs-6 wow fadeIn" data-wow-delay="1.6s"><img src="images/team3.jpg" class="img-responsive" alt="team img">
        <div class="team-des">
          <h4>Pixy</h4>
          <h3>Creative Designer/Visualizer</h3>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-offset-3 col-md-6 col-sm-offset-2 col-sm-8 title">
        <h2>Portfolio</h2>
        <hr>
        <p>Come and check our portfolio.</p>
      </div>
      <div class="col-md-12 col-sm-12"></div>
      <div class="col-md-3 col-sm-3 wow fadeIn" data-wow-delay="0.6s"><a href="images/p1.jpg" data-lightbox-gallery="portfolio-gallery"><img src="images/p1.jpg" alt="portfolio img"></a></div>

      <div class="col-md-3 col-sm-3 wow fadeIn" data-wow-delay="0.6s"><a href="images/p2.jpg" data-lightbox-gallery="portfolio-gallery"><img src="images/p2.jpg" alt="portfolio img"></a></div>

      <div class="col-md-3 col-sm-3 wow fadeIn" data-wow-delay="0.6s"><a href="images/p3.jpg" data-lightbox-gallery="portfolio-gallery"><img src="images/p3.jpg" alt="portfolio img"></a></div>

      <div class="col-md-3 col-sm-3 wow fadeIn" data-wow-delay="0.6s"><a href="images/p4.jpg" data-lightbox-gallery="portfolio-gallery"><img src="images/p4.jpg" alt="portfolio img"></a></div>

      <div class="col-md-3 col-sm-3 wow fadeIn" data-wow-delay="0.6s"><a href="images/p5.jpg" data-lightbox-gallery="portfolio-gallery"><img src="images/p5.jpg" alt="portfolio img"></a></div>

      <div class="col-md-3 col-sm-3 wow fadeIn" data-wow-delay="0.6s"><a href="images/p6.jpg" data-lightbox-gallery="portfolio-gallery"><img src="images/p6.jpg" alt="portfolio img"></a></div>
      <div class="col-md-3 col-sm-3 wow fadeIn" data-wow-delay="0.6s"><a href="images/p7.jpg" data-lightbox-gallery="portfolio-gallery"><img src="images/p7.jpg" alt="portfolio img"></a></div>
...
<section id="contact">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-offset-3 col-md-6 col-sm-offset-2 col-sm-8 contact-form wow fadeInUp" data-wow-delay="0.9s"><img src="images/apx.jpg"></a></div>
